...
async def back_to_menu(callback: CallbackQuery,  state: FSMContext):
    ...
    elif previous_state == UserState.basket_section:
        await show_user_cart(callback, state)

    elif previous_state == UserState.basket_item_select:
        await show_selected_product(callback, state)
